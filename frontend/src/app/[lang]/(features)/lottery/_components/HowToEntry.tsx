        ...
        <Card className='h-96 w-full border-2 border-gray-500 bg-gray-900'>
          <CardContent>
            ...
            <div className='my-2 grid max-h-48 grid-cols-2 justify-center'>
              <Image src='/images/lottery/medal.png' alt='medal' width={250} height={250} />
              <Image src='/images/lottery/ticket.png' alt='ticket' width={250} height={250} />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className='h-96 w-full border-2 border-gray-500 bg-gray-900'>
          <CardContent>
            ...
            <div className='flex justify-center'>
              <Image src='/images/lottery/lotteryBox.png' alt='medal' width={300} height={300} />
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            ...
            <div className='grid max-h-40 grid-cols-5'>
              <div className='col-span-3'>
                <Image src='/images/lottery/yuki.png' alt='medal' width={280} height={280} />
              </div>
              <div className='col-span-2 mt-10'>
                <Image src='/images/lottery/popper.png' alt='medal' width={200} height={200} />
              </div>
            </div>
          </CardContent>
        </Card>
