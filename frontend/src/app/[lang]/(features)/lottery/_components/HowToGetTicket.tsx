    ...
    <div className='pb-12'>
      <FadeInBottom>
        <div className='my-4 grid grid-cols-1 items-center gap-2 md:grid-cols-5'>
          <div className='col-span-2 flex items-center justify-center'>
            <Image src='/images/staking/staking.png' alt='medal' width={500} height={500} />
          </div>
          <div className='md:col-span-3 md:ml-8'>
            ...
            <Typography variant='lead' className='text-base md:text-xl [&_span]:inline-block'>
              <Trans
                i18nKey='lottery:howToGetTicket1Detail'
                t={t}
                components={{
                  lnk: (
                    <LinkText href='https://made-in-maids.cryptomaids.tokyo/' className='text-yellow-300 underline' />
                  ),
                }}
              />
            </Typography>
      ...
      <FadeInBottom>
        <div className='my-4 grid grid-cols-1 items-center justify-center gap-4 md:grid-cols-5'>
          <div className='col-span-2 flex items-center justify-center'>
            <Image src='/images/lottery/mogm.png' alt='mogm' width={500} height={500} />
          </div>
          <div className='md:col-span-3 md:ml-8'>
            ...
            <Typography variant='lead' className='text-base md:text-xl'>
              <Trans
                ...
                t={t}
                components={{
                  lnk: <LinkText href='/market' className='text-yellow-300 underline' />,
                }}
              />
            </Typography>
          </div>
