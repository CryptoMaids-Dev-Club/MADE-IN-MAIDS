...
import type {
	Prediction,
	PredictionText,
} from '@/app/(features)/prediction/_types'
	...
	return (
		<>
			<Typography variant='h4'>
				Correct Answer:{' '}
				{predictionInfo.isSettled
					? predictionText.choices[predictionInfo.result]
					: 'Pending'}
			</Typography>
			...
			<LoadingButtonForWeb3
				...
				loading={isLoading}
				disabled={
					!predictionInfo.isSettled || rewardAmount === 0 || userInfo?.isClaimed
				}
			>
				{buttonMessage}
			</LoadingButtonForWeb3>
