...
export async function GET(_req: NextRequest, { params }: { params: { address: string; page: string } }) {
  const ownedNfts = await fetchOwnedNFTs(params.address as Address, Number(params.page))
